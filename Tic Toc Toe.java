...
class Main {
    ...
    public static void main(String[] args) {
        ...
        title.setForeground(new Color(31, 122, 140));
        title.setBackground(new Color(197, 195, 198));
        ...
        panel.setBackground(new Color(197, 195, 198));
        panel.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(197, 195, 198), 15));

        title2 = new JLabel("Player 1, it's your turn");
        title2.setHorizontalAlignment(SwingConstants.CENTER);
        title2.setBackground(Color.white);
        title2.setForeground(new Color(31, 122, 140));
                        ...
                        if (enabled) {
                            if (label.getText().toString().equals(" ")) {
                                ...
                                if (turn == 'X') {
                                    ...
                                    label.setForeground(new Color(255, 209, 0));
                                    turn = 'X';
        ...
        btn.setBackground(new Color(31, 122, 140));
